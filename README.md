# WEBSITE DEPLOYMENT USING AWS DEVOPS(IMPLEMENTING DEVOPS ON AWS)
...
1. **Clone the Repository** (Open Command Prompt & run below):
   ```bash
   git clone https://github.com/AnandNimmalapudi/project.git
   cd DevopsProject2
...
pipeline {
    ...
    stages {
        stage('1. Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/AnandNimmalapudi/project.git'
            }
        }
